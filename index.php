...
<body>
  <div class="hero_area">
    ...
    $query = mysqli_query($conn, "SELECT * FROM product  order by id desc limit 12");
    ?>
    <!-- end header section -->
    <!-- slider section -->
      ...
      <div class="feature_container">
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
            Our dedicated delivery team works efficiently to ensure to Deliver Products in 3 Working Days
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
            All the medicines available on our platform are approved and licensed by government health authorities.    </p>
          </div>
        </div>
        <div class="box">
          <div class="img-box">
          ...
          <div class="detail-box">
            ...
            <p>
              Our dedicated support team is available 24/7 to assist you with any inquiries or assistance.
            </p>
          </div>
        </div>
      </div>
          ...
          $ctr = 0;
            ...
            <div class="col-lg-3">
              <div class="box">
                ...
                <div class="img-box">
                  <img src="<?=$result['img_url'];?>" alt="" style='width: 150px; height: 200px;'>
                </div>
                <div class="detail-box">
